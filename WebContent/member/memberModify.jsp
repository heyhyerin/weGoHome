		...
		<form action="${conPath }/memberModify.do" method="post">
			<table class="modify-table">
				...
				<tr>
					<th>아이디</th>
					<td>
						<input type="text" name="mid" id="mid" class="data-input" value="${member.mid }"
							readonly="readonly">
					</td>
				</tr>
				<tr>
					<th>이름</th>
					<td>
						<input type="text" name="mname" id="mname" class="data-input" value="${member.mname }"
							readonly="readonly">
					</td>
				</tr>
				<tr>
					<th>현재 비밀번호</th>
					<td>
						<input type="password" name="oldmpw" id="oldmpw" class="data-input"
				...
				<tr>
					<th>휴대전화 번호</th>
					<td>
						<input type="text" name="mtel" id="mtel" value="${member.mtel }" class="data-input">
				...
				<tr>
					<th>이메일</th>
					<td>
						<input type="email" name="memail" id="memail" value="${member.memail }" class="data-input">
				...
				<tr>
					...
					<c:if test="${member.mgender eq 'M' }">
						<td>
							<input type="radio" name="mgender" value="M" checked="checked">
							남 &nbsp;
							<input type="radio" name="mgender" value="F">
							여
						</td>
					...
					<c:if test="${member.mgender eq 'F' }">
						<td>
							<input type="radio" name="mgender" value="M">
							남 &nbsp;
							<input type="radio" name="mgender" value="F" checked="checked">
							여
						</td>
					</c:if>
				</tr>
				<tr>
					<th>생년월일</th>
					<td>
						<input type="text" name="mbirth" id="datepicker" value="${member.mbirth }" class="data-input">
					</td>
				</tr>
				<tr>
					<th>주소</th>
					<td>
						<input type="text" name="maddress" value="${member.maddress }" class="data-input">
					</td>
				</tr>
				<tr>
					<td colspan="2" class="center">
						<input type="button" value="회원 탈퇴" class="btn-grey">
